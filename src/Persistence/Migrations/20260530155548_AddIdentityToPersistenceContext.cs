...
{
    /// <inheritdoc />
    public partial class AddIdentityToPersistenceContext : Migration
    {
        /// <inheritdoc />
        ...
        {
            migrationBuilder.Sql("IF OBJECT_ID(N'[AspNetRoleClaims]', N'U') IS NOT NULL DROP TABLE [AspNetRoleClaims];");
            migrationBuilder.Sql("IF OBJECT_ID(N'[AspNetUserClaims]', N'U') IS NOT NULL DROP TABLE [AspNetUserClaims];");
            migrationBuilder.Sql("IF OBJECT_ID(N'[AspNetUserLogins]', N'U') IS NOT NULL DROP TABLE [AspNetUserLogins];");
            migrationBuilder.Sql("IF OBJECT_ID(N'[AspNetUserRoles]', N'U') IS NOT NULL DROP TABLE [AspNetUserRoles];");
            migrationBuilder.Sql("IF OBJECT_ID(N'[AspNetUserTokens]', N'U') IS NOT NULL DROP TABLE [AspNetUserTokens];");
            migrationBuilder.Sql("IF OBJECT_ID(N'[AspNetRoles]', N'U') IS NOT NULL DROP TABLE [AspNetRoles];");
            migrationBuilder.Sql("IF OBJECT_ID(N'[AspNetUsers]', N'U') IS NOT NULL DROP TABLE [AspNetUsers];");
        }
    }
}
